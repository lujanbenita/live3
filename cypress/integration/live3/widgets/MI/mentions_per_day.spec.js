...
describe('The "Mentions per Day (avg)" widget', () => {
  beforeEach(() => {
    cy.loadDashboard();
    cy.get("#widget-mi-mentions-per-day").as("widget");
  ...
  it("is loaded", () => {
    cy.get("@widget").contains("Mentions per Day (avg)");
    cy.get("@widget").contains("4k");
  ...
  it("refreshes after adding and removing filter", () => {
    ...
    cy.get("@widget").contains("Mentions per Day (avg)");
    cy.get("@widget").contains("2k");
    cy.get("@widget").contains("1459");
