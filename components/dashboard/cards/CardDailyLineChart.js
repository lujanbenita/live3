...
import DailySentimentTrendChart from "@/components/charts/DailySentimentTrendChart";
...
function CardDailyLineChart({ title, subtitle, data, onClick, ...props }) {
...
export default CardDailyLineChart;
