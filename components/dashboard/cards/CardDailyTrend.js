...
import DailySentimentTrendVsPeersChart from "@/components/charts/DailySentimentTrendVsPeersChart";
...
function CardDailyTrend({ title, subtitle, data, onClick, ...props }) {
    ...
    <div className="c-card c-card--big" id={idPrint}>
      ...
      <div className="c-card__body">
        <div className="c-card-daily-line">
          <DailySentimentTrendVsPeersChart
