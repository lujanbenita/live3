...
import TopIssuesByVolumeChart from "@/components/charts/TopIssuesByVolumeChart";

function CardIssuesByVolume({ title, subtitle, data, onClick, ...props }) {
  ...
  return (
    <div className="c-card" id={idPrint}>
      ...
      <div className="c-card__body">
        <div className="c-issues-by-volume">
          <TopIssuesByVolumeChart
...
export default CardIssuesByVolume;
